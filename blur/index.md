...
The technique is basically shrink the image, then enlarge it again to generate the heavilly blured result. The [Gaussian Filter](../filters/#gaussian) is especially useful for this as you can directly specify a [Gaussian Sigma](../filters/#sigma) define.
...
This technique can be used to generate a spreading shadow on the ground. Alternatively you could generate a motion blur, then radial blur it a little though that requires some image shifting to get the center right. You can also add some extra [Image Warping](../warping/) to make things even more interesting...
